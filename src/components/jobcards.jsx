            ...
            <div className="col-md-4 col-sm-4">
              <div className="single-cat text-center mb-50">
                ...
                <div className="cat-cap">
                  ...
                  <p>
                    If you are struggling to get an interior paint finish which
                    can help tie together your architraves, the skirtings, the
                    furniture, items of fine art, etc., it is time to get your
                    home or business painted to enhance its look.{" "}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="single-cat text-center mb-50">
                ...
                <div className="cat-cap">
                  ...
                  <p>
                    ...
                    the outside? It is time to act fast and end your frustration
                    with the sloppy job done by uncaring painters.
                  </p>
                </div>
              </div>
            </div>
